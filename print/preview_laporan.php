...
<head>
    <meta charset="UTF-8">
    <title>Preview Laporan Penjualan</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="actions">
            ...
            <a href="../pages/admin/laporan.php?mulai=<?php echo $filterMulai; ?>&sampai=<?php echo $filterSampai; ?>" class="btn btn-back">Kembali</a>
        </div>
